...
if ($_SESSION['ult_actividad'] < time() - $_SESSION['expira']) {
    ...
    $query = "SELECT * FROM sanitario WHERE especialidad = 'enfermero' AND trabajo = '$lm' AND provincia = (SELECT provincia FROM sanitario WHERE colegiado = '$user') ORDER BY RAND() LIMIT 1;";
    ...
    $query_cardio = "SELECT * FROM sanitario WHERE especialidad = 'cardiologo' AND provincia = (SELECT provincia FROM sanitario WHERE colegiado = '$user') ORDER BY RAND() LIMIT 1;";
    $res4 = mysqli_query($db,$query_cardio);
    $cardiologo = mysqli_fetch_assoc($res4);
    $lc = $cardiologo['trabajo'];
    $tc = $cardiologo['tipo_trabajo'];
     
    $query_trauma = "SELECT * FROM sanitario WHERE especialidad = 'traumatologo' AND provincia = (SELECT provincia FROM sanitario WHERE colegiado = '$user') ORDER BY RAND() LIMIT 1;";
    $res5 = mysqli_query($db,$query_trauma);
    $traumatologo = mysqli_fetch_assoc($res5);
    $lt = $traumatologo['trabajo'];
    $tt =  $traumatologo['tipo_trabajo'];

    $query_oft = "SELECT * FROM sanitario WHERE especialidad = 'oftalmologo' AND provincia = (SELECT provincia FROM sanitario WHERE colegiado = '$user') ORDER BY RAND() LIMIT 1;";
    $res6 = mysqli_query($db,$query_oft);
    $oftalmologo = mysqli_fetch_assoc($res6);
    $lo = $oftalmologo['trabajo'];
    $to = $oftalmologo['tipo_trabajo'];

    $query_gine = "SELECT * FROM sanitario WHERE especialidad = 'ginecologo' AND provincia = (SELECT provincia FROM sanitario WHERE colegiado = '$user') ORDER BY RAND() LIMIT 1;";
...
<!DOCTYPE html>
    <html>
        ...
        <body>
                ...
                <form name="reg" action="server/pedircita.php" method="POST">
                    ...
                    <div id="c2" class="mb-3">
                        ...
                        <select id="tipocita" name="tipocita" onchange="mostrarCampos(); obtenerlugar();" >
                            ...
                            <option value="dig">Digestivo</option>
                            <option value="car">Cardiologo</option>
                            <option value="trau">Traumatologo</option>
                            <option value="oft">Oftalmologo</option>
                    ...
                    <div id="c5" class="mb-3 hidden">
                        <label for="digest" class="form-label">Digestivo</label>
                    ...
                    <div id="c6" class="mb-3 hidden">
                        <label for="cardio" class="form-label">Cardiologo</label>
                    ...
                    <div id="c7" class="mb-3 hidden">
                        <label for="traumat" class="form-label">Traumatologo</label>
                    ...
                    <div id="c8" class="mb-3 hidden">
                        <label for="oftalm" class="form-label">Oftalmologo</label>
                    ...
                    <div id="c9" class="mb-3 hidden">
                        <label for="ginecol" class="form-label">Ginecologo</label>
                    ...
                    <div id="c19" class="mb-3">
                            <label for="tipo" class="form-label">Lugar Asignado</label>
            ...
            <a class="textLinks" href="sanitario.php">< Volver a inicio</a>
            </div>
